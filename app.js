...
createApp({
    ...
    computed: {
        sortedResults() {
            ...
            const sorted = [...this.results].sort((a, b) => {
                ...
                // Handle numeric sorting for PMID and Year
                if (this.sortColumn === 'PMID' || this.sortColumn === 'Year') {
    ...
    methods: {
        ...
        exportToCSV() {
            ...
            // Create CSV content
            const headers = ['PMID', 'Title', 'Authors', 'Journal', 'Year', 'DOI', 'DOI_Link', 'PubMed_URL'];
